...
const TimingDask = () => {
  ...
  const events = [
    ...
    },
    {
      ...
      time: '11:00',
      title: 'Այց «Հայփոստ»',
      description: 'Պատկերացում ձևավորել ծառայությունների դիմաց վճարման, փոխանցումների, հերթագրման և պատասխանատու սպասարկման մասին։',
      icon: '📮',
    ...
    },
    {
      ...
      description: 'Ծանոթացնել ծառայությունների փաթեթներին, գների համեմատմանը, զեղչերին և ֆինանսական պլանավորման տարրերին։',
      icon: '✈️',
    ...
    },
    {
      ...
      description: 'Գործնականում կիրառել գնում–վճարում–մանրի ստացում հմտությունները, տարբերել կարիքներն ու ցանկությունները, ձևավորել խնայող վերաբերմունք։',
      icon: '🛒',
  ...
  const learningPoints = [
    ...
    'Ինչու է կարևոր խնայել և մտածված ծախսել',
